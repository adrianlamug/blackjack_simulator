...
class Blackjack:
    def __init__(self):
        ...
        self.animation_duration = 60  # Number of frames for the animation
        self.current_frame = 0

        self.current_card_indexes = []

        # Create a list to keep track of flipped cards positions
    ...
    def generate(self):
        # this should return the card rectangle of the chosen card
    ...
    def slide_card(self):
        ...
        # Update sprite_rect self.position
        self.pos.topleft = (current_x, current_y)

        # Draw the sprite at the updated self.position
